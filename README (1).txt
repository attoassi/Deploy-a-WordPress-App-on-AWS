...
# Hosting a WordPress Web App on AWS

This repository contains the resources and scripts used to deploy a WordPress web application on Amazon Web Services (AWS). The project leverages various AWS services to ensure high availability, scalability, fault tolerance, and security for the WordPress application.
