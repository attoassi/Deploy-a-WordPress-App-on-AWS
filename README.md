# Deploy_a_WordPress_Web_App_on_AWS
...
The WordPress website is hosted on an EC2 instances within a highly available and secure architecture that includes:
...
- Public Subnets used for the NAT Gateway and Application Load Balancer, facilitating external access, fault tolerance, and load balancing.
...
6. Configure Route 53 for the registered Domaine Name, and the HTTPS listener on the Load Balancer to encrypt commucation between the end users and your website. 
